...
class VPSEvaluator(DatasetEvaluator):
    ...
    def process(self, inputs, outputs):
        ...
        for segments_info in segments_infos:
            ...
            if is_thing:
                sem = self.contiguous_id_to_thing_dataset_id[sem - len(self.contiguous_id_to_stuff_dataset_id)] #self.contiguous_id_to_stuff_dataset_id[sem]
            else:
                sem = self.contiguous_id_to_stuff_dataset_id[sem]
